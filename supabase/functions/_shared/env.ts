...
export const SESSION_TIMEOUT_MS = getIntegerEnv('SESSION_TIMEOUT_MS', 60 * 60 * 1000, 60 * 1000, 24 * 60 * 60 * 1000);
export const MESSAGE_COOLDOWN_MS = getIntegerEnv('MESSAGE_COOLDOWN_MS', 3000, 1000, 60 * 1000);
export const MESSAGE_WINDOW_MS = getIntegerEnv('MESSAGE_WINDOW_MS', 60 * 1000, 10 * 1000, 10 * 60 * 1000);
export const MESSAGE_WINDOW_LIMIT = getIntegerEnv('MESSAGE_WINDOW_LIMIT', 8, 1, 100);
